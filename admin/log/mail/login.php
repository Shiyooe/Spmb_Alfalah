...
<body class="font-sans">
    ...
    <div class="w-full max-w-sm mx-auto">
        <div class="glass-card p-8 text-center relative">
            ...
            <!-- Header -->
            <h1 class="text-3xl font-bold text-white mb-2">✨ Silahkan Login </h1>
            <p class="text-sm text-white/80 mb-6">Masuk ke Admin Dashboard</p>

            <form action="adminlogin.php" method="POST">
                <div class="mb-5 text-left">
                    <label class="block text-xs font-semibold text-white/80 mb-1.5">📧 Email</label>
                    <input
                ...
                <div class="mb-5 text-left">
                    <label class="block text-xs font-semibold text-white/80 mb-1.5">🔒 Password</label>
                    <input
                        class="w-full p-3.5 rounded-xl bg-white/10 border border-white/20 text-white placeholder:text-white/50 transition-all duration-300 focus:border-femboy-accent"
                        type="password"
                        name="password"
                ...
                <div class="flex justify-between items-center mb-6 text-xs">
                    <label class="flex items-center space-x-2 cursor-pointer">
                        ...
                        <span class="text-white/80">Ingatkan</span>
                    </label>
                    <a href="password.php" class="text-white/80 hover:underline font-medium">Lupa? 😳</a>
                </div>

                <button type="submit" class="w-full py-3.5 rounded-xl bg-gradient-to-r from-femboy-accent to-primary-blue text-white font-semibold shadow-lg femboy-glow hover:opacity-90 transition-all duration-300 transform hover:scale-[1.02]">
                    ✨ Masuk Sekarang!
                </button>
            </form>

            <div class="mt-8 pt-6 border-t border-white/15 text-center">
                <p class="text-xs text-white/80">Belum ada akun?</p>
                <a href="register.php" class="text-white/80 font-semibold hover:text-white transition">Daftar di sini</a>
            </div>
        </div>
