    ...
    <form id="ppdb-form">
      ...
      <div class="form-section">
        ...
        <div class="form-group">
          ...
          <input type="text" id="alamat" name="alamat" placeholder="Jalan, No. Rumah" required />
        </div>
        <div class="form-row">
          <div class="form-group">
            <label for="rt">RT</label>
            <input type="number" id="rt" name="rt" min="1" placeholder="001" required />
          </div>
          <div class="form-group">
            <label for="rw">RW</label>
            <input type="number" id="rw" name="rw" min="1" placeholder="001" required />
          </div>
        </div>
        <div class="form-row">
          <div class="form-group">
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <input type="text" id="kode_pos" name="kode_pos" maxlength="5" placeholder="40123" required />
          </div>
          <div class="form-group">
