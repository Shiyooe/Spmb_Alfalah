document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("editBtn").onclick = () => {
    // Kembali ke form.php. Data akan dimuat ulang dari localStorage
    window.location.href = "from.php";
  };
  ...
  document.getElementById("confirmBtn").onclick = async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error('Server tidak mengirim response JSON yang valid. Response: ' + responseText.substring(0, 100));
      }
      ...
      if (result.success) {
        ...
        // Redirect ke halaman selesai (asumsi Anda punya selesai.php)
